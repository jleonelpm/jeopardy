                    ...
                    <form action="{{ route('questions.update', $question) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="correct_answer" id="correct_answer" rows="2"
                                ...
                                required>{{ old('correct_answer', $question->correct_answer) }}</textarea>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <select name="points" id="points"
                                    ...
                                    <option value="100" {{ old('points', $question->points) == 100 ? 'selected' : '' }}>100</option>
                                    <option value="200" {{ old('points', $question->points) == 200 ? 'selected' : '' }}>200</option>
                                    <option value="300" {{ old('points', $question->points) == 300 ? 'selected' : '' }}>300</option>
                                    <option value="400" {{ old('points', $question->points) == 400 ? 'selected' : '' }}>400</option>
                                    <option value="500" {{ old('points', $question->points) == 500 ? 'selected' : '' }}>500</option>
                                </select>
                                @error('points')
                                    <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="number" name="time_limit" id="time_limit" value="{{ old('time_limit', $question->time_limit) }}"
                                    min="10" max="300"
